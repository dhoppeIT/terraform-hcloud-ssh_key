...
This example will manage the Hetzner Cloud SSH key and provides the public key as file.

## Graph

<img alt="Graph" src="https://github.com/dhoppeIT/terraform-hcloud-ssh_key/blob/main/examples/file/rover.svg?raw=true" width="100%" height="100%">
